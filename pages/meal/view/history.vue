...
import { today } from "../../../appSettings/export/default";
const activeDate = ref<string>(today);

import { useI18n } from "vue-i18n";
const { t } = useI18n();

import { getFoodArrayByDate, getMealById } from "../../../appSettings/export/food";
...
<template>
  ...
  <div class="w-100 flex-c block" v-for="item in history">
