...
export const authNavigationArray: tNavigationItem[] = [
  { index: 0, title: "lang", svg: Languages },
  { index: 1, title: "sett", svg: Cog },
  { index: 2, title: "body", svg: DraftingCompass },
  { index: 3, title: "goal", svg: Sparkles },
  { index: 4, title: "macro", svg: Apple },
  { index: 5, title: "signUp", svg: LogIn }, 
];
export const authNavigationItem: tNavigationItem = { index: 0, title: "signIn", svg: UserRound };
export const dashboardNavigationArray: tNavigationItem[] = [
  { index: 0, title: "home", svg: House },
  { index: 1, title: "meal", svg: Apple },
  { index: 2, title: "sport", svg: BicepsFlexed },
  // { index: 4, title: "goal", svg: Dumbbell },
  { index: 3, title: "meds", svg: Pill },
  { index: 4, title: "storage", svg: Package2 },
  // { index: 6, title: "meds", svg: HeartPlus },
];
...
const activityOpt: tSelectOpt[] = [
  ...
  { title: "activityLevel2", worth: 1.20 },
  { title: "activityLevel3", worth: 1.35 },
  { title: "activityLevel4", worth: 1.50 },
  { title: "activityLevel5", worth: 1.65 },
  { title: "activityLevel6", worth: 1.80 },
];
